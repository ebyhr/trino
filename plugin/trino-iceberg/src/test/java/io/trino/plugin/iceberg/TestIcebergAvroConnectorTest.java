        ...
        extends BaseIcebergConnectorTest
{
    ...
    {
        // AVRO doesn't support statistics
        assertThatThrownBy(super::testLocalDynamicFilteringWithSelectiveBuildSideJoin)
                .hasMessage("result set must have exactly one row");
    }
