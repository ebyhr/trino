        ...
        implements Provider<Procedure>
{
    ...
    public void unregisterTable(ConnectorAccessControl accessControl, ConnectorSession clientSession, String schemaName, String tableName)
    {
        try (ThreadContextClassLoader ignored = new ThreadContextClassLoader(getClass().getClassLoader())) {
            doUnregisterTable(accessControl, clientSession, schemaName, tableName);
        }
    }

    private void doUnregisterTable(ConnectorAccessControl accessControl, ConnectorSession clientSession, String schemaName, String tableName)
    {
        ...
        catalog.dropTable(clientSession, schemaTableName, false);
    }
}
