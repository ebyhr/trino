...
public final class DataStaxQueryRunner
{
    private DataStaxQueryRunner() {}

    public static DistributedQueryRunner createScyllaQueryRunner(
            TestingDataStaxServer server,
            ...
            throws Exception
    {
        ...
        DistributedQueryRunner queryRunner = createScyllaQueryRunner(
                new TestingDataStaxServer(),
                ImmutableMap.of("http-server.http.port", "8080"),
                ImmutableMap.of(),
                TpchTable.getTables());

        Logger log = Logger.get(DataStaxQueryRunner.class);
